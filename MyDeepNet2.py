class MyDeepConvNet2:
    ...
    def __init__(self, input_dim=(1, 28, 28),
        ...
        pre_node_nums = np.array([1*3*3, 16*3*3, 32*3*3, 64*3*3, hidden_size])
        ...
        self.params['W4'] = weight_init_scales[3] * np.random.randn(64*3*3, hidden_size)
        self.params['b4'] = np.zeros(hidden_size)
        self.params['W5'] = weight_init_scales[3] * np.random.randn(hidden_size, hidden_size)
    ...
    def gradient(self, x, t):
        ...
        # 設定
        grads = {}
        for i, layer_idx in enumerate((0, 3, 6, 9,11)):
